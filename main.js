...
eval("{\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://calakitchen/./node_modules/css-loader/dist/runtime/noSourceMaps.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://calakitchen/./node_modules/style-loader/dist/runtime/insertStyleElement.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://calakitchen/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://calakitchen/./node_modules/style-loader/dist/runtime/styleTagTransform.js?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _home_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home.js */ \"./src/home.js\");\n/* harmony import */ var _menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu.js */ \"./src/menu.js\");\n/* harmony import */ var _about_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./about.js */ \"./src/about.js\");\n\n\n\n\n\nconst display = document.querySelector(\"#content\");\nconst navButtons = document.querySelectorAll(\"nav button\");\n\n_home_js__WEBPACK_IMPORTED_MODULE_1__.home.displayContent(display);\n\nnavButtons.forEach(button => {\n  button.addEventListener('click', e => {\n    e.preventDefault();\n\n    if (button.dataset.id == \"home\") {\n      display.textContent = \"\";\n      _home_js__WEBPACK_IMPORTED_MODULE_1__.home.displayContent(display);\n      return;\n    }\n\n    if (button.dataset.id == \"menu\") {\n      display.textContent = \"\";\n      _menu_js__WEBPACK_IMPORTED_MODULE_2__.menu.displayMenu(display);\n      return;\n    }\n\n    if (button.dataset.id == \"about\") {\n      display.textContent = \"\";\n      _about_js__WEBPACK_IMPORTED_MODULE_3__.about.displayAbout(display);\n      return;\n    }\n  });\n});\n\n//# sourceURL=webpack://calakitchen/./src/index.js?\n}");
